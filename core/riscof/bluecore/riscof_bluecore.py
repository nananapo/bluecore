...
class bluecore(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mypath = "/home/kanataso/Documents/bluecore/core/obj_dir/sim"
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "", mypath)
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
          ...
          if self.target_run:
            ...
            utils.shellCommand(cmd).run(cwd=test_dir)
            # run core command
            execute = self.dut_exe + " " + str(elf) + ".hex 1000000 > " + logfile
          ...
          print("writing signatures", len(sigs))
